...
const ResolutionActionPage: React.FC = () => {
  ...
  const config: Record<string, { icon: React.ReactNode; title: string; message: string; color: string; bgColor: string; borderColor: string }> = {
    accepted: {
      ...
      title: t('resolution.acceptedTitle'),
      message: t('resolution.acceptedMessage'),
    ...
    rejected: {
      ...
      title: t('resolution.rejectedTitle'),
    ...
    invalid: {
      ...
      title: t('resolution.invalidTitle'),
      message: t('resolution.invalidMessage'),
    ...
    'already-processed': {
      ...
      title: t('resolution.processedTitle'),
      message: t('resolution.processedMessage'),
      color: 'text-gray-800',
      bgColor: 'bg-gray-50',
