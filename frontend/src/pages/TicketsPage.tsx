          ...
          <table className="w-full text-left">
            <thead>
              {selectedTicketIds.length > 0 ? (
                <tr className="border-b-2 border-gray-200 dark:border-gray-700/80 bg-gray-50/50 dark:bg-[#1a1d24] transition-colors animate-in fade-in duration-200 z-10 relative">
                  ...
                  <th colSpan={isEmployee ? 6 : 8} className="px-3 lg:px-5 py-2 font-normal text-left">
                ...
                <tr className="border-b-2 border-gray-200 bg-gray-50/50 transition-colors animate-in fade-in">
                  ...
                  {renderSortableHeader('title', 'Tytuł', 'min-w-[200px] lg:min-w-[250px]')}
            ...
            <tbody className="divide-y divide-gray-50">
              {filteredTickets.length === 0 ? (
                <tr>
                  <td colSpan={(isAdmin || isTechnician) ? 9 : 6} className="px-4 lg:px-5 py-12 text-center text-gray-500 text-sm italic">
                ...
                paginatedTickets.map(ticket => (
                  <tr key={ticket.id} className={`transition-colors ${selectedTicketIds.includes(ticket.id)
                    ...
                    <td className="px-3 xl:px-5 py-2.5 text-sm font-medium text-gray-400 dark:text-gray-500 whitespace-nowrap">#{ticket.id}</td>
                    <td className="px-3 xl:px-5 py-2.5 text-sm max-w-[200px] sm:max-w-[250px] lg:max-w-[350px]">
                      {selectedTicketIds.length > 0 ? (
                        <div
                          title={ticket.title}
                    ...
                    <td className="px-3 xl:px-5 py-2.5 text-sm text-gray-600 whitespace-nowrap">
                    ...
                    {!isEmployee && (
                      <td className="px-3 xl:px-5 py-2.5 whitespace-nowrap">
                    ...
                    <td className="px-3 xl:px-5 py-2.5 text-sm text-gray-700 dark:text-gray-300 whitespace-nowrap font-medium">
                    ...
                    {!isEmployee && (
                      <td className="px-3 xl:px-5 py-2.5 text-sm whitespace-nowrap">
                    ...
                    <td className="px-3 xl:px-5 py-2.5 text-sm text-gray-500 whitespace-nowrap">
